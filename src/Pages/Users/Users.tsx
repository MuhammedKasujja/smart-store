...
const Users: React.FC = () => {
  ...
  useEffect(() => {
    setUser({
      first_name: "Kasujja",
      last_name: "Muhammed",
      mobile: "+256 774262923",
      description: "",
      dob: "",
      picture: "",
      email: "admin@davinon.com",
      created_at: "222-07-92",
      updated_at: "45",
      id: "5678",
      type: "admin",
      password: "123456",
  ...
  return (
    <>
      ...
      <RadioButton
        checked={"Married" === maritalStatus}
        label={"Married"}
        onChange={setMaritalStatus}
      />
      <RadioButton
        checked={"Single" === maritalStatus}
        label={"Single"}
        onChange={setMaritalStatus}
      />
      <RadioButton
        checked={"Divorced" === maritalStatus}
        label={"Divorced"}
        onChange={setMaritalStatus}
      />
