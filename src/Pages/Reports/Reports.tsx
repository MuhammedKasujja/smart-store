const Reports: React.FC = () => {
    const dropdownFunction = (data: any)=>{}
    ...
    return (<>
        <div className="sm:px-6 w-full">
            ...
            <div className="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10 rounded-xl">
                            ...
                            <tr tabIndex={0} className="focus:outline-none h-16 border border-gray-100 rounded">
                                ...
                                <td>
                                    <div className="relative px-5 pt-2">
                                        <button className="focus:ring-2 rounded-md focus:outline-none" onClick={dropdownFunction} role="button" aria-label="option">
                                            <svg className="dropbtn" onClick={dropdownFunction} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
